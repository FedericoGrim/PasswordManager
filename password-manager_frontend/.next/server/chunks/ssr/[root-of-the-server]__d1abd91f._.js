...
const updateSubAccount = async (subAccount, userId, salt)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/V1/subaccount/${userId}/${subAccount.id}`, {
...
const deleteSubAccount = async (user_id, subaccount_id)=>{
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/api/V1/subaccount/${user_id}/${subaccount_id}`);
    } catch (error) {
...
function ProfilePage() {
    ...
    const HandleDeleteSubAccount = async (sa)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$apis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteSubAccount"])(sa.user_id.toString(), sa.id.toString());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d1abd91f._.js.map