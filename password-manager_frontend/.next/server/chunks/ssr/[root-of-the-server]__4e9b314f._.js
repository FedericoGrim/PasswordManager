...
"[project]/src/app/pages/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProfilePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const FetchData = async ()=>{
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$apis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSubAccountsByUserId"])("6ff9e31e-0b64-4c7d-a972-37893f98841c");
            setSubAccounts(data);
        };
        FetchData();
    }, []);
    const HandleDeleteSubAccount = async (id)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$apis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteSubAccount"])(id);
        setSubAccounts((prev)=>prev.filter((sa)=>sa.id !== id));
    };
    const HandleEditClick = (sa)=>{
        sessionStorage.setItem("editSubAccount", JSON.stringify(sa));
        router.push("/edit-subaccount"); // percorso consigliato
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e9b314f._.js.map