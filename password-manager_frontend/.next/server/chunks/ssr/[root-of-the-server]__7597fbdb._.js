...
const deleteSubAccount = async (userId, subaccountId)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/api/V1/subaccount`, {
            params: {
                userId,
                subaccountId
            }
...
function EditSubAccountPage() {
    ...
    const handleSave = async ()=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$apis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateSubAccount"])(subAcc, userId, salt); // aggiungi user_id
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7597fbdb._.js.map